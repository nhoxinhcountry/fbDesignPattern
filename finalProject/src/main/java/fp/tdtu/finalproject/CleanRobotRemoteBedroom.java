 ...
 * @author Trong Dai
 */
public class CleanRobotRemoteBedroom extends javax.swing.JFrame {

    /**
     * Creates new form CleanRobotRemote
     */
    public CleanRobotRemoteBedroom() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CleanRobotRemoteBedroom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CleanRobotRemoteBedroom().setVisible(true);
            }
        });
    }
